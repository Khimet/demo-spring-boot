...
public class MissionRepositoryTests {
	...
	void findByDateDebutGreaterThanEqual() {
		...
		List<Mission> missions = missionRepository.listerProchainesMissions();
	...
	void findByDateDebutGreaterThanEqualAndTauxJournalierGreaterThanEqual() {
		...
		List<Mission> missions = missionRepository.listerProchainesMissionsJTM(new BigDecimal("25.5"));
		assertThat(missions).extracting(Mission::getLibelle).contains("Mission 2");
	}
